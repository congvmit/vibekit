...
uvx --from git+https://github.com/congvmit/vibekit.git vibekit init <project_name> --ai gemini
uvx --from git+https://github.com/congvmit/vibekit.git vibekit init <project_name> --ai copilot
...
```bash
uvx --from git+https://github.com/congvmit/vibekit.git vibekit init <project_name> --script sh
uvx --from git+https://github.com/congvmit/vibekit.git vibekit init <project_name> --script ps
```
...
```bash
uvx --from git+https://github.com/congvmit/vibekit.git vibekit init <project_name> --ai claude --ignore-agent-tools
```
...
- `/vibekit.plan` - Generate implementation plans  
- `/vibekit.tasks` - Break down into actionable tasks

The `.vibekit/scripts` directory will contain both `.sh` and `.ps1` scripts.
