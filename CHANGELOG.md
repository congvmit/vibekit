...
- All command files now prefixed with `vibekit.` (e.g., `vibekit.specify.md`, `vibekit.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
